...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_name', models.CharField(max_length=14, unique=True, verbose_name='单据编号')),
                ('order_date', models.DateField(blank=True, null=True, verbose_name='单据日期')),
                ...
                ('status', models.CharField(choices=[('open', '开立'), ('submit', '提交'), ('confirm', '审核'), ('cancel', '作废')], max_length=1, verbose_name='单据状态')),
                ('desc', models.CharField(blank=True, max_length=128, null=True, verbose_name='备注')),
